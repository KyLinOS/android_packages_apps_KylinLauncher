...
package com.kylin.launcher.stress;


import com.kylin.launcher.Launcher;
...
/**
 * Run rotation stress test using KylinLauncher for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "KylinLauncherRotationStressTest";
