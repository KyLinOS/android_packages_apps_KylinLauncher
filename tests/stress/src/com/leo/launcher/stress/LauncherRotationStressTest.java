...
package com.leo.launcher.stress;


import com.leo.launcher.Launcher;
...
/**
 * Run rotation stress test using LeoLauncher for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "LeoLauncherRotationStressTest";
