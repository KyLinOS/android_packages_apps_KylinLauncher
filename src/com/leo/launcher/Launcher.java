...
import com.leo.launcher.DropTarget.DragObject;
import com.leo.launcher.preference.*;
...
public final class Launcher extends Activity
    ...
    private static final String TAG = "LeoLauncher.Launcher";
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.leo.launcher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    protected void onActivityResult(
        ...
        if (resultCode == RESULT_OK && mPendingAddInfo.container != com.leo.launcher.ItemInfo.NO_ID) {
    ...
    private void restoreState(Bundle savedState) {
        ...
        if (pendingAddContainer != com.leo.launcher.ItemInfo.NO_ID && pendingAddScreen > -1) {
    ...
    void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
        ...
        if (info != null) {
            ...
            info.container = com.leo.launcher.ItemInfo.NO_ID;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_SCREEN_OFF.equals(action)) {
                ...
                if (mAppsCustomizeTabHost != null && mPendingAddInfo.container == com.leo.launcher.ItemInfo.NO_ID) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mPendingAddInfo.container != com.leo.launcher.ItemInfo.NO_ID && mPendingAddInfo.screen > -1 &&
                mWaitingForResult) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // Hide preferences if not on LeoSalmonOS or not default launcher
        // (in which case preferences don't get shown in system settings)
        boolean preferencesVisible = !getPackageManager().hasSystemFeature("com.leo.android") ||
    ...
    private void resetAddInfo() {
        mPendingAddInfo.container = com.leo.launcher.ItemInfo.NO_ID;
