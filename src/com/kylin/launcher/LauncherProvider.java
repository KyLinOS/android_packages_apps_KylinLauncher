...
public class LauncherProvider extends ContentProvider {
    private static final String TAG = "KylinLauncher.LauncherProvider";
    ...
    static final String AUTHORITY = "com.kylin.launcher.settings";
    ...
    private static final String ACTION_APPWIDGET_DEFAULT_WORKSPACE_CONFIGURE =
            "com.kylin.launcher.action.APPWIDGET_DEFAULT_WORKSPACE_CONFIGURE";
